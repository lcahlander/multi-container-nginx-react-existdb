...
public class JWTModule extends AbstractInternalModule {
    ...
    public static final String NAMESPACE_URI = "https://exist-db.org/exist-db/ns/jwtd";
    public static final String PREFIX = "jwtd";
    public static final String RELEASED_IN_VERSION = "eXist-6.0.1";

    // register the functions of the module
    public static final FunctionDef[] functions = functionDefs(
        functionDefs(JWTFunctions.class,
                JWTFunctions.FS_DECODE_JWT
        )
    );

    public JWTModule(final Map<String, List<? extends Object>> parameters) {
